...
for dname in dfiles:
  ...
  plt.suptitle("COOPERATION"+str(tstates)+"s"+str(rop)+"r (R/P)") #label entire figure, eliminate for final figs
  plt.show() #doesn't show if PS is invoked
  plt.savefig("COOPERATE"+str(tstates)+"s"+str(rop)+"r") #create a PS file of the fig
